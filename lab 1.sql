...
(
  ...
  isnew VARCHAR(3) NOT NULL CHECK (isnew = 'Yes' OR isnew = 'No'),
...
CREATE INDEX indx ON books (num ASC , name ASC);
DROP INDEX indx ON books;
ALTER TABLE books ADD UNIQUE indx2 (num DESC, name ASC);
ALTER TABLE books DROP INDEX indx2;